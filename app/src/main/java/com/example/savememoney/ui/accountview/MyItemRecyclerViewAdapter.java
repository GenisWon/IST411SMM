package com.example.savememoney.ui.accountview;
...
import com.example.savememoney.ui.accountview.ListFragment.OnListFragmentInteractionListener;
...
public class MyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder> {
    ...
    public MyItemRecyclerViewAdapter(List<AccountItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdView.setText(mValues.get(position).strName);
